...
<html lang="it">
    ...
    <body class="body font">
        ...
        <main class="marginx6">
            ...
            <div class="d-flex flex-column align-items-center mt-5" id="Div-Accettazioni">
                <?php 
                $eventiPerCitta = $eventiInSospesoPerCitta;
                include "Cards.php" 
                ?>
            </div>
            <div class="d-flex flex-column align-items-center mt-5 d-none" id="Div-Segnalazioni">
                <?php 
